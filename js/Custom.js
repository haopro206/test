var sound = new Howl({
    ...
    volume: 0.5, // Điều chỉnh âm lượng (tùy chọn)
    onload: function() {
        console.log('Nhạc đã tải xong!');
        sound.play(); // Bắt đầu phát nhạc khi đã tải xong
    },
    onend: function() {
            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                        "<<< Merry Christmas >>>",
                        "Giáng sinh vui vẻ nhaaaaa, Chúc bọn ngu ai cha cha map có một mùa noel thật ấm áp bên người yêu nhé",
                        "Hảo iu mn nhiều"
                        ],
                        typeSpeed: 70,
                        startDelay: 80,
